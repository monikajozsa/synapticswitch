using Gillespie # add "https://github.com/monikajozsa/Gillespie.jl"
using Random
...
@time Wall, Hall, maxXXall, kvec, xbarvec =  main(1,[3. 5. 7. 9. 11. 13. 15.])
matwrite("A1_gill_asymm_inh.mat", Dict("Wall" => Wall, "Hall" => Hall, "maxXXall" => maxXXall, "kvec" =>  kvec, "xbarvec" => xbarvec))

@time Wall, Hall, maxXXall, kvec, xbarvec =  main(2,[3. 5. 7. 9. 11. 13. 15.])
matwrite("A2_gill_asymm_inh.mat", Dict("Wall" => Wall, "Hall" => Hall, "maxXXall" => maxXXall, "kvec" =>  kvec, "xbarvec" => xbarvec))

@time Wall, Hall, maxXXall, kvec, xbarvec =  main(3,[3. 5. 7. 9. 11. 13. 15.])
matwrite("A3_gill_asymm_inh.mat", Dict("Wall" => Wall, "Hall" => Hall, "maxXXall" => maxXXall, "kvec" =>  kvec, "xbarvec" => xbarvec))

@time Wall, Hall, maxXXall, kvec, xbarvec =  main(4,[3. 5. 7. 9. 11. 13. 15.])
matwrite("A4_gill_asymm_inh.mat", Dict("Wall" => Wall, "Hall" => Hall, "maxXXall" => maxXXall, "kvec" =>  kvec, "xbarvec" => xbarvec))

@time Wall, Hall, maxXXall, kvec, xbarvec =  main(5,[3. 5. 7. 9. 11. 13. 15.])
matwrite("A5_gill_asymm_inh.mat", Dict("Wall" => Wall, "Hall" => Hall, "maxXXall" => maxXXall, "kvec" =>  kvec, "xbarvec" => xbarvec))

@time Wall, Hall, maxXXall, kvec, xbarvec =  main(6,[3. 5. 7. 9. 11. 13. 15.])
